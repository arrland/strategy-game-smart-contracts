...
async function main() {
    ...
    if (network.name == "amoy") {
        ...
        pirateStorageAddress = "0xE218A366e07a358Cf7782641E6CE7a7920C10A90";
        ...
        pirateStorageAddress = "0xC617FE2c8B4C0dF871E07b3796Fda41BD0996E7C";
    ...
    const contractsToVerify = [        
        { contract: resourceFarmingRules, args: [centralAuthorizationRegistryAddress] },
        { contract: resourceSpendManagement, args: [centralAuthorizationRegistryAddress] },
        { contract: resourceTypeManager, args: [centralAuthorizationRegistryAddress] },
