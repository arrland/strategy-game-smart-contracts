...
contract ShipNFT is ERC721, ERC721Burnable, ERC721Enumerable, AccessControlEnumerable, ERC2981 {
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    string private _currentBaseURI;    

    constructor(address defaultAdmin, address _minter, address _royaltyRecipient) ERC721("Ships of Arrland", "Ships") {
        _grantRole(DEFAULT_ADMIN_ROLE, defaultAdmin);
        _grantRole(MINTER_ROLE, defaultAdmin);
        _grantRole(MINTER_ROLE, _minter);
        _currentBaseURI = "https://arrland-media.s3-eu-central-1.amazonaws.com/meta/shipsV2/";
